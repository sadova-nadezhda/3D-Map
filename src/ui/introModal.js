...
const INTRO_COPY = {
  ...
  kz: {
    title: 'Қазақстанның көше тағамдары: Ақтаудан Өскеменге дейін',
    description:
      '«STREETХАНА» сериалының тұсаукесеріне орай біз стритфуд картасын жасап шығардық. Онда еліміздің әр қаласындағы танымал тағамдар мен олардың дәмін татып көруге болатын орындар жинақталған.',
    button: 'Кеттiк!',
