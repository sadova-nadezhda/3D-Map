...
const INTRO_COPY = {
  ru: {
    title: 'Как выглядит Казахстан на вкус?',
    description:
      'К выходу сериала «STREETХАНА» мы собрали карту стритфуда — с блюдами, которые любят в разных городах Казахстана, и точками, где их можно найти.',
    button: 'Исследовать!',
