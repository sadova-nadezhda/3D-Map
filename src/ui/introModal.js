...
const INTRO_COPY = {
  ...
  kz: {
    ...
    description:
      '«STREETХАНА» сериалының шығуына орай біз Қазақстанның әр қаласында сүйіп жейтін стритфуд тағамдары мен оларды табуға болатын орындар белгіленген карта жасадық.',
    button: 'Іздеу!',
